...
public class UnityEmbodimentDemo {
    ...
    protected static JFrame mainJFrame = new JFrame("AsapRealizer Demo - UnityEmbodiment");

    public static void main(String[] args) throws IOException {
    	UnityEmbodimentDemo uas = new UnityEmbodimentDemo();
    	uas.init();
    }
    ...
    public void init() throws IOException {
        String spec = "Unity/agentspecs/uma_default.xml"; // From AsapUnityResources
        ...
        ee.loadVirtualHuman("", spec, "AsapRealizer Demo - UnityEmbodiment");
